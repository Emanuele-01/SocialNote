...
const NavAction = () => {
    ...
    return (
        <>
            <Navbar data-bs-theme="dark" className="navAction-css justify-content-center">
                ...
                <Nav>
                    ...
                    <Nav.Item className="me-3">
                        <Button variant="dark border border-0 navActionColor rounded-circle p-2" onClick={handleShow}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" className="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                                                    ...
                                                    signOut === true ? (
                                                        <>
                                                            <Button variant="dark-outline border border-1 ps-5 pe-5 me-3" onClick={handleClose}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-x-square-fill" viewBox="0 0 16 16">
                                                            ...
                                                            <Button variant="dark-outline border border-1 ps-5 pe-5 me-3" type="submit" onClick={handleClose}>
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-send-plus-fill" viewBox="0 0 16 16">
